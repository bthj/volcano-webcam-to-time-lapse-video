...
#	eval avconv -y -r 12 -i "$1$2/$4/$4_%04d.png" -s 720x576 -b 8M -r 25 "$3/DV_12fps/Eyjafjallajokull_$4.dv"
	/usr/bin/avconv -y -r 15 -i "$1$2/$4/$4_%04d.png" -s 720x576 -vf "drawtext=fontfile=$FONTFILE:text=$DATE_FULL:fontsize=18:fontcolor=white@0.66:x=20:y=540"  -b 8M -r 25 "$3/DV_15fps/Eyjafjallajokull_$4.dv"
